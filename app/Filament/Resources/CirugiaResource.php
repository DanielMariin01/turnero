...
use App\Filament\Resources\CirugiaResource\Pages;
use App\Filament\Resources\CirugiaResource\RelationManagers;
    ...
    public static function getEloquentQuery(): Builder
{
    ...
    return parent::getEloquentQuery()
        ...
        ->where('motivo', 'cirugia');
        //->with(['paciente', 'modulo', 'consultorio']);
}

   public static function getNavigationBadge(): ?string
{
        return Cache::remember('cirugias_badge', 60, function () {
...
->label('Motivo')
    ...
    {
        return [
            'index' => Pages\ListCirugias::route('/'),
            'create' => Pages\CreateCirugia::route('/create'),
            'edit' => Pages\EditCirugia::route('/{record}/edit'),
        ];
    }
}
